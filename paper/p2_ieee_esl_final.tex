\documentclass[journal,twoside,9pt]{IEEEtran}
...
\usepackage{cite}
\usepackage{balance}
\usepackage[font=small,skip=2pt,labelsep=period]{caption}
...
\author{Akul~Mallayya~Swami%
  \thanks{Manuscript received April 2026. This work was conducted independently.}%
  \thanks{A.~M.~Swami is with Varian Medical Systems, A Siemens Healthineers Company,
  Palo Alto, CA 94304 USA (e-mail: swami.akul@alumni.uml.edu).
  ...
  Portions of this manuscript were drafted with the assistance of Claude (Anthropic);
...
{Swami: Architectural Isolation as a Timing Safety Primitive for Edge AI Medical Devices}
...
\IEEEPARstart{F}{DA} pre-market validation of AI-enabled medical devices evaluates
